...
interface Props {
    ...
    setLowerAge: Dispatch<SetStateAction<number>>;
    setUpperAge: Dispatch<SetStateAction<number>>;
    setCurrAge: Dispatch<SetStateAction<number | undefined>>
}

export default function GeneralInfoCard({lowerAge, upperAge, currAge, setLowerAge, setUpperAge, setCurrAge}: Props) {
  return (
    <form className="p-8 bg-gray-800 rounded-lg shadow-lg text-gray-200 max-h-fit">
        ...
        <div className="grid md:grid-cols-2 md:gap-x-6">
            ...
            <div className="relative z-0 w-full mb-6 group">
                <input value={currAge || ""} onChange={(e) => setCurrAge(Number(e.target.value))} type="number" name="floating_age" id="floating_age" className="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-6 group">
                <input value={lowerAge} onChange={(e) => setLowerAge(Number(e.target.value))} type="number" name="floating_target_start_age" id="floating_target_start_age" className="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div className="relative z-0 w-full mb-6 group">
                <input value={upperAge} onChange={(e) => setUpperAge(Number(e.target.value))} type="number" name="floating_last_name" id="floating_last_name" className="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
