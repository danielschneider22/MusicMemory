...
export default function GenreSubmission(props: { disabled: boolean}) {
    ...
    return (
        <>
          ...
          <button disabled={props.disabled} id="button" type="submit" className="bg-indigo-600 mb-6 shadow-xl hover:bg-indigo-500 text-white font-bold rounded-full p-4 w-48 mx-auto">Add Songs</button>
        </>
    )
  }
