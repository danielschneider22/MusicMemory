...
export default function GenreCard() {
    ...
    return (
      <div className={`p-2 pt-8 bg-gray-800 rounded-lg shadow-lg text-gray-200 text-center relative ${!data.currAge && 'opacity-20'}`}>
          {loading && <div style={{marginTop: "-2rem", marginLeft: "-.5rem", zIndex: 100}} className={"w-full bg-gray-800 h-full absolute bg-opacity-80"}/>}
          <h1 className="text-center mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white">Genres</h1>
            {loading && <div style={{zIndex: 101}} role="status" className="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
