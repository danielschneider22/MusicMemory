    ...
    return (
      <div className={"bg-gray-800 rounded-lg shadow-lg text-gray-200 pt-8 pb-8"}>
          ...
          <div className="grid md:grid-cols-1 md:gap-6">
              ...
              <button disabled={!artist || !artist.label} onClick={() => addArtistSongs()} id="button" type="button" className="disabled:bg-indigo-800 bg-indigo-600 shadow-xl hover:bg-indigo-500 text-white font-bold rounded-full p-4 w-48 mx-auto">Add Songs</button>
          </div>
